...
// Do we have support for MySQL with InnoDB?
if (!function_exists('mysql_connect'))
	exit('Your host does not support MySQL with InnoDB. MySQL with InnoDB support is required to use a MySQL with InnoDB database to run Luna.');
